...
def display_startup_banner():
    ...
    logger.info("=" * 60)
    logger.info("ALKIMI SLACK BOT (MCP-Enabled)")
    logger.info("=" * 60)
    ...
    logger.info("  ✓ MCP (Model Context Protocol) tools")
    ...
    logger.info("  ✓ P&L calculations (FIFO/LIFO/Average)")
    logger.info("  ✓ Query history")
    logger.info("  ✓ OTC transaction management")
    logger.info("  ✓ DEX analytics (Sui: Cetus, Turbos, BlueMove)")
    logger.info("  ✓ Treasury and holder tracking")
    logger.info("=" * 60)
    logger.info("")
